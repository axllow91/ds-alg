...
public class HashTable<Key, Value> {
    ...
    private int capacity; // it is the max numb of items that can be inserted in the table: numbOfItems < capacity
